...
public class Frame extends JFrame {
    ...
    public Frame() {
        ...
        addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyPressed(java.awt.event.KeyEvent e) {
                ...
                } //System.out.println(KeyEvent.VK_M+"\t"+e.getKeyCode()+"\t"+e.getKeyChar()+"\t"+KeyEvent.getKeyText(e.getKeyChar()));
    ...
    public void Colorized(int c) {
        ...
        checar(1, 0);//checa a la derecha
        checar(0, 1);//checa hacia abajo
    ...
    public void checar(int indice, int indice2) {
        ...
        try {
            if (color == panel1.mat[indice][indice2].getcolor()) {
                ...
                //if(indice2!=panel1.mat.length-1)//sur
                checar(indice, indice2 + 1);
            } else {
                return;
            }
    ...
    public void checar2(int indice, int indice2) {
        ...
        try {
            if (color == panel1.mat[indice][indice2].getcolor()) {
                ...
                if (indice < panel1.mat.length-1)//east
                {
                    checar2(indice + 1, indice2);
                }
                if (indice2 > 0)//norte
                ...
                if (indice2 < panel1.mat[0].length-1)//south
                {
                    checar2(indice, indice2 + 1);
                }
            } else {
    ...
    public void dormir(int s){
    try{
        System.out.printf("Entre a Dormir\n");
        Thread.sleep(s);
        panel1.repaint();
        System.out.printf("Sali de Dormir\n");
